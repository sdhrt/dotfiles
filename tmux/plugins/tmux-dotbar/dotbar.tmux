...
fg=$(get_tmux_option "@tmux-dotbar-fg" '#4C4C4C')
bg=$(get_tmux_option "@tmux-dotbar-bg" '#000000')
fg_current=$(get_tmux_option "@tmux-dotbar-fg-current" '#D0D0D0')
fg_session=$(get_tmux_option "@tmux-dotbar-fg-session" '#D0D0D0')
fg_prefix=$(get_tmux_option "@tmux-dotbar-fg-prefix" '#9EC1C1')
...
status_left=$("$left_state" && get_tmux_option "@tmux-dotbar-status-left" "#[bg=$bg,fg=$fg_session]#{?client_prefix,, #{session_id} }#[bg=$fg_prefix,fg=$bg,bold]#{?client_prefix, #{session_id} ,}#[bg=$bg,fg=${fg_session}]")
...
tmux set-option -g window-status-current-format "#[bg=${bg},fg=${fg_current}]${window_status_format}#[fg=#9EC1C1,bg=${bg}]#{?window_zoomed_flag,${maximized_pane_icon},}#[fg=${bg},bg=default]"
